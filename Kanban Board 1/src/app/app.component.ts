...
export class AppComponent {
  ...
  constructor() {
    const tareasJSON: string = `{
      "tareas": [
        { "lista": "${k_FINALIZADAS_LISTA}", "img": "https://picsum.photos/300/50", "titulo": "Tarea 1: Diseño UI", "usuarios": [{"img": "https://picsum.photos/300/300", "alt": "Usuario"}], "fechaFin": "2019-01-16" },
        { "lista": "${k_PROGRESO_LISTA}", "img": "https://picsum.photos/300/50", "titulo": "Tarea 2: Diseño de todo el Backend", "usuarios": [], "fechaFin": "2022-11-09" },
